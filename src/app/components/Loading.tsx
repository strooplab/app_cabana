...
const Loading: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const completeTimer = setTimeout(() => {
      setProgress(100);
      setLoadingText("Recurso cargado exitosamente");
    }, 4000);
      ...
      <div className="text-center max-w-md w-full mx-auto space-y-8">
        ...
        <div className="relative mb-12">
          ...
          <div className="relative w-28 h-28 bg-dark/10 rounded-3xl flex items-center justify-center mx-auto backdrop-blur-sm border-2 border-yellow/40 shadow-lg">
            ...
            <div className="absolute -bottom-3 -left-3 w-10 h-10 bg-orange rounded-full flex items-center justify-center animate-bounce shadow-md" style={{ animationDelay: '0.5s' }}>
              <Download className="h-5 w-5 text-dark" />
            </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-dark/70 text-base font-medium">
            Cargando aplicación campo
          </p>
        </div>

        {/* Cargando barra de carga */}
        <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-yellow/30 shadow-xl space-y-6 mt-2">
        ...
        {/* Feature Highlights */}
        <div className="grid grid-cols-3 gap-5 text-center mt-3 items-center justify-center">
          <div className="bg-yellow/30 backdrop-blur-sm rounded-xl p-4 border-2 border-yellow/40 shadow-md">
            <Shield className="h-8 w-8 text-dark mx-auto mb-4" />
          ...
          <div className="bg-orange/30 backdrop-blur-sm rounded-xl p-4 border-2 border-orange/40 shadow-md">
            <Zap className="h-8 w-8 text-dark mx-auto mb-4" />
            <span className="text-sm font-semibold text-dark">Rápido</span>
          </div>
          <div className="bg-yellow/20 backdrop-blur-sm rounded-xl p-4 border-2 border-dark/30 shadow-md">
            <Download className="h-8 w-8 text-dark mx-auto mb-4" />
            <span className="text-sm font-semibold text-dark">Fácil</span>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-dark/50 text-sm font-medium">
            Versión 2.0 • Sistema de distribución de app campo
          </p>
        </div>
      </div>
    </div>
